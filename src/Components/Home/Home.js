    ...
    return (
        <div className='Home'>
            ...
            <div id="header">
                ...
                <h1>Welcome to KisaanVend.</h1>
                <p>KisaanVend – a one step solution for farmers
            ...
            <div id="main" style={{ backgroundColor: "#EF8172" }}>
                ...
                <header className="major container medium">
                    <h2 style={{ color: 'black' }}>KisaanVend is a webapp through which farmers can sell crops to and buy
